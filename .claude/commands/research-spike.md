...
```yaml
spike_number: 42
spike_title: "Brand Guide Implementation"
phase: research  # setup | research | synthesis | issues | complete
completed_agents:
  - codebase
  - external
research_files:
  - docs/research/42-codebase.md
  - docs/research/42-external.md
created_issues: []
blockers: []
```
...
```bash
git worktree add ../gvns.ca-issue-$ARGUMENTS -b spike/$ARGUMENTS-research
cd ../gvns.ca-issue-$ARGUMENTS
```
...
- Create in `docs/research/prototype-<name>.astro` (or appropriate extension)
