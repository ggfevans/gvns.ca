  ...
  description: (
    <>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        I'm a Victoria based <strong className="text-stone-100">Solutions Engineer</strong>, currently working at{' '}
        <strong className="text-stone-100">VertiGIS</strong> helping people meet their GIS application needs.
      </p>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        In my free time time, you can catch me training in <strong className="text-stone-100">Jiu Jitsu</strong>,
        running on <strong className="text-stone-100">trails</strong>, or exploring beautiful{' '}
...
export const aboutData: About = {
  ...
  aboutItems: [
    ...
    {label: 'Employment', text: 'VertiGIS', Icon: BuildingOffice2Icon},
  ],
};
...
export const contact: ContactSection = {
  ...
  items: [
    ...
    },
    {
      ...
      text: '@ggfevans',
      href: 'https://www.instagram.com/ggfevans/',
    },
    {
